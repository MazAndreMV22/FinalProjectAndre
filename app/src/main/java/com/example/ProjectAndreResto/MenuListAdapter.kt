...
class MenuListAdapter(private val listMenu: ArrayList<Makanan>) : RecyclerView.Adapter<MenuListAdapter.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val (nama, deskripsi, image) = listMenu[position]
        holder.apply {
